...
from common.core import Protocol, TaskSchema, TaskSchemaLike, Suitability
...
class ProtocolPicker:
    ...
    def check_protocol_for_task(self, protocol_document : str, task_schema : TaskSchemaLike):
    ...
    def pick_protocol(self, task_schema : TaskSchemaLike, *protocol_lists : List[Protocol]):
